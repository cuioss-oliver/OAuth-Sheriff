...
| The module bundle drops below `BRANCH >= 0.80` (inherited from `cui-java-parent`)
...
[NOTE]
.Maintainer note — editing the gate's `<includes>`
====
...
failure mode of a typo here is therefore a *false green* that silently reopens the blind spot this
