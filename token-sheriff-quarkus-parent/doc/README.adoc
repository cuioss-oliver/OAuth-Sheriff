...
* **xref:../token-sheriff-client-quarkus/src/main/resources/META-INF/quarkus-config-doc.adoc[Client Configuration Reference]** - All `sheriff.client.*` properties and defaults
