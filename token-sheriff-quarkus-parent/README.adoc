...
* xref:token-sheriff-validation-quarkus/src/main/resources/META-INF/quarkus-config-doc.adoc[Quarkus Configuration Documentation] - All `sheriff.token.*` properties for the validation extension
* xref:token-sheriff-client-quarkus/src/main/resources/META-INF/quarkus-config-doc.adoc[Client Quarkus Configuration Documentation] - All `sheriff.client.*` properties for the client-engine extension
